...
int main(int argc, char **argv)
{
    ...
    screen = tigrWindow(640, 480, "Tzing circle to circle test", TIGR_FIXED);
    ...
    while (!quit) {
        ...
        if (Tzing_CircleToCircle(circle1_x, circle1_y, circle1_radius, 
         circle2_x, circle2_y, circle2_radius))
